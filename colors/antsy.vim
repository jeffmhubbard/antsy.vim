...
if !exists("g:antsy_termcolors")
  let g:antsy_termcolors = 16
endif

" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:antsy_terminal_italics")
  let g:antsy_terminal_italics = 0
endif

" This function is based on one from FlatColor: https://github.com/MaxSt/FlatColor/
" Which in turn was based on one found in hemisu: https://github.com/noahfrederick/vim-hemisu/
function! s:h(group, style)
  if g:antsy_terminal_italics == 0
...
call s:h("Comment", { "fg": s:dark_grey, "gui": "italic", "cterm": "italic" }) " any comment
...
call s:h("Cursor", { "fg": s:dark_grey, "bg": s:blue }) " the character under the cursor
call s:h("CursorIM", {}) " like Cursor, but used when in IME mode
call s:h("CursorColumn", { "bg": s:black }) " the screen column that the cursor is in when 'cursorcolumn' is set
if &diff
...
call s:h("CursorLineNr", { "fg": s:grey, "cterm": "bold" }) " Like LineNr when 'cursorline' or 'relativenumber' is set for the cursor line.
...
call s:h("ModeMsg", { "bg": s:black, "fg": s:cyan }) " 'showmode' message (e.g., "-- INSERT --")
...
call s:h("TabLineSel", {  "bg": s:blue, "fg": s:black }) " tab pages line, active tab page label
...
"if has("nvim")
"  let g:terminal_color_0 =  s:dark_grey.gui
